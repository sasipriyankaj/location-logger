...
function sendDataToThingSpeak(latitude, longitude) {
    var apiUrl = "https://api.thingspeak.com/update?api_key=NV546FB2TVNX3T1K&field1=" + latitude + "&field2=" + longitude;
...
function fetchThingSpeakData() {
    var apiUrl = "https://api.thingspeak.com/channels/2517667/feeds.json?api_key=N3NPCIQ77BQHRU9A&results=1";
